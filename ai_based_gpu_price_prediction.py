#ทำงานได้ดีกับข้อมูลที่ไม่สมบูรณ์
#ข้อมูลราคาที่เก็บจากหลายเว็บไซต์มักมี ข้อมูลหาย ช่วงเวลาไม่ต่อเนื่อง Prophet สามารถ จัดการข้อมูลลักษณะนี้ได้ค่อนข้างดี
